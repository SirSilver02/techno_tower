local folder 				= (...):gsub("%.", "/")
local room_folder 			= folder .. "/room"
local shadow_shapes_folder 	= folder .. "/shadowshapes"

local Shadows = {
	--[[
	body 			= require(folder .. "/Body"),
	body_tranform 	= require(folder .. "/BodyTransform"),
	light 			= require(folder .. "/Light"),
	light_world 	= require(folder .. "/LightWorld"),
	object			= require(folder .. "/Object"),
	output_shadow	= require(folder .. "/OutputShadow"),
	priority_queue 	= require(folder .. "/PriorityQueue"),
	star			= require(folder .. "/Star"),
	transform 		= require(folder .. "/Transform"),

	room = {
		circle_room 	= require(room_folder .. "/CircleRoom"),
		polygon_room 	= require(room_folder .. "/PolygonRoom"),
		rectangle_room 	= require(room_folder .. "/RectangleRoom"),
		room 			= require(room_folder .. "/Room")
	},

	shadow_shapes = {
		circle_shadow 	= require(shadow_shapes_folder .. "/CircleShadow"),
		height_shadow 	= require(shadow_shapes_folder .. "/HeightShadow"),
		image_shadow 	= require(shadow_shapes_folder .. "/ImageShadow"),
		normal_shadow 	= require(shadow_shapes_folder .. "/NormalShadow"),
		polygon_shadow 	= require(shadow_shapes_folder .. "/PolygonShadow"),
		shadow 			= require(shadow_shapes_folder .. "/Shadow")
	}
	]]
}
